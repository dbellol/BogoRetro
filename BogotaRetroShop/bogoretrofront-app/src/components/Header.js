      ...
      <div className='row'>
          <div className='' style={{ backgroundColor: '#000000' }} ></div>
            <div className='logocont col-auto d-flex align-items-center me-3'>
                ...
                <div>
                    <Link className='ubicacion gap-10 text-white me-3 ms-3' to="https://maps.app.goo.gl/FcYuZak2ag3siy299">
          ...
          <div className='col-5'>
              <div className="input-group ">
                  <input type="text" className="form-control py-2 ms-3" placeholder="Busca un producto aquí" aria-label="Busca un producto aquí" aria-describedby="basic-addon2"/>
          ...
          <div className='col-5'>
            <div className='header-upper-links d-flex align-items-center justify-content-between'>
              <div>
                <Link to='/compare' className='d-flex align-items-center gap-10 text-white me-3 ms-3'>
              ...
              <div>
                <Link to='/wishlist' className='d-flex align-items-center gap-10 text-white me-3 ms-3'>
              ...
              <div>
                <Link to ='/login' className='d-flex align-items-center gap-10 text-white me-3 ms-3'>
                  <img className='login' src={process.env.PUBLIC_URL + '/images/user.svg'} alt="login" />
                  <p className='mb-0'>Ingresa <br />a tu cuenta</p>
                </Link>
              </div>
              <div>
                <Link to='/cart' className='d-flex align-items-center gap-10 text-white ms-3'>
