...
const Cart = () => {
  ...
  useEffect(() => {
    let sum = 0;
    for (let index = 0; index < userCarState?.length; index++) {
      sum =
        sum + Number(userCarState[index].quantity) * userCarState[index].price;
      setTotalAmount(sum);
    }
  }, [userCarState]);
  ...
  return (
    <>
      ...
      <BreadCrumb title="Carrito de compras"></BreadCrumb>
      <Container class1="cart-wrapper home-wrapper-2 py-5">
        <div className="row">
          <div className="col-12">
            ...
            {Array.isArray(userCarState) &&
              userCarState?.map((item, index) => {
                return (
                  <div
                    key={index}
              ...
              <div className="d-flex justify-content-between align-items-baseline">
                ...
                </Link>
                {
                  ...
                  <div className="d-flex flex-column align-items-end">
                    ...
                    <p>
                      Los impuestos y envíos son calculados al finalizar la compra
                    </p>
